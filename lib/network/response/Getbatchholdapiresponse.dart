...
//
//     final getbatchholdapiresponse = getbatchholdapiresponseFromJson(jsonString);

import 'dart:convert';

List<Getbatchholdapiresponse> getbatchholdapiresponseFromJson(String str) =>
    List<Getbatchholdapiresponse>.from(
        json.decode(str).map((x) => Getbatchholdapiresponse.fromJson(x)));

String getbatchholdapiresponseToJson(List<Getbatchholdapiresponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Getbatchholdapiresponse {
  String status;
  String message;
  GetbatchholdapiresponseData data;

  Getbatchholdapiresponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory Getbatchholdapiresponse.fromJson(Map<String, dynamic> json) =>
      Getbatchholdapiresponse(
        status: json["status"] ?? "",
        message: json["message"] ?? "",
        data: GetbatchholdapiresponseData.fromJson(json["data"]),
      );
...
class GetbatchholdapiresponseData {
  String id;
  ...
  factory GetbatchholdapiresponseData.fromJson(Map<String, dynamic> json) =>
      GetbatchholdapiresponseData(
        id: json["id"] ?? "",
