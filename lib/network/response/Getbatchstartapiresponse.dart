...
//
//     final getbatchstartapiresponse = getbatchstartapiresponseFromJson(jsonString);

import 'dart:convert';

List<Getbatchstartapiresponse> getbatchstartapiresponseFromJson(String str) =>
    List<Getbatchstartapiresponse>.from(
        json.decode(str).map((x) => Getbatchstartapiresponse.fromJson(x)));

String getbatchstartapiresponseToJson(List<Getbatchstartapiresponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Getbatchstartapiresponse {
  String status;
  String message;
  GetbatchstartapiresponseData data;

  Getbatchstartapiresponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory Getbatchstartapiresponse.fromJson(Map<String, dynamic> json) =>
      Getbatchstartapiresponse(
        status: json["status"] ?? "",
        message: json["message"] ?? "",
        data: GetbatchstartapiresponseData.fromJson(json["data"]),
      );
...
class GetbatchstartapiresponseData {
  String id;
  ...
  factory GetbatchstartapiresponseData.fromJson(Map<String, dynamic> json) =>
      GetbatchstartapiresponseData(
        id: json["id"] ?? "",
