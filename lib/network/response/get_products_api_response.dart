...
//
//     final getProductsApiResponse = getProductsApiResponseFromJson(jsonString);

import 'dart:convert';

List<GetProductsApiResponse> getProductsApiResponseFromJson(String str) =>
    List<GetProductsApiResponse>.from(
        json.decode(str).map((x) => GetProductsApiResponse.fromJson(x)));

String getProductsApiResponseToJson(List<GetProductsApiResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetProductsApiResponse {
  String status;
  String message;
  List<GetProductsApiResponseDatum> data;
  ...
  factory GetProductsApiResponse.fromJson(Map<String, dynamic> json) =>
      GetProductsApiResponse(
        status: json["status"] ?? "",
        message: json["message"] ?? "",
        data: List<GetProductsApiResponseDatum>.from(
            json["data"].map((x) => GetProductsApiResponseDatum.fromJson(x))),
      );
...
class GetProductsApiResponseDatum {
  String id;
  String clientId;
  String branchName;
  String itemGroup;
  ...
  factory GetProductsApiResponseDatum.fromJson(Map<String, dynamic> json) =>
      GetProductsApiResponseDatum(
        id: json["id"] ?? "",
