...
//
//     final getbatchstopapiresponse = getbatchstopapiresponseFromJson(jsonString);

import 'dart:convert';

List<Getbatchstopapiresponse> getbatchstopapiresponseFromJson(String str) =>
    List<Getbatchstopapiresponse>.from(
        json.decode(str).map((x) => Getbatchstopapiresponse.fromJson(x)));

String getbatchstopapiresponseToJson(List<Getbatchstopapiresponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Getbatchstopapiresponse {
  String status;
  String message;
  GetbatchstopapiresponseData data;

  Getbatchstopapiresponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory Getbatchstopapiresponse.fromJson(Map<String, dynamic> json) =>
      Getbatchstopapiresponse(
        status: json["status"] ?? "",
        message: json["message"] ?? "",
        data: GetbatchstopapiresponseData.fromJson(json["data"]),
      );
...
class GetbatchstopapiresponseData {
  String id;
  ...
  factory GetbatchstopapiresponseData.fromJson(Map<String, dynamic> json) =>
      GetbatchstopapiresponseData(
        id: json["id"] ?? "",
