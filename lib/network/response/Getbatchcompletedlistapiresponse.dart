...
//
//     final getbatchcompletedlistapiresponse = getbatchcompletedlistapiresponseFromJson(jsonString);

import 'dart:convert';

List<Getbatchcompletedlistapiresponse> getbatchcompletedlistapiresponseFromJson(
        String str) =>
    List<Getbatchcompletedlistapiresponse>.from(json
        .decode(str)
        .map((x) => Getbatchcompletedlistapiresponse.fromJson(x)));

String getbatchcompletedlistapiresponseToJson(
        List<Getbatchcompletedlistapiresponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Getbatchcompletedlistapiresponse {
  String status;
  String message;
  List<GetbatchcompletedlistapiresponseDatum> data;

  Getbatchcompletedlistapiresponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory Getbatchcompletedlistapiresponse.fromJson(
          Map<String, dynamic> json) =>
      Getbatchcompletedlistapiresponse(
        status: json["status"],
        message: json["message"],
        data: List<GetbatchcompletedlistapiresponseDatum>.from(json["data"]
            .map((x) => GetbatchcompletedlistapiresponseDatum.fromJson(x))),
      );
...
class GetbatchcompletedlistapiresponseDatum {
  String id;
  ...
  GetbatchcompletedlistapiresponseDatum({
    required this.id,
  ...
  factory GetbatchcompletedlistapiresponseDatum.fromJson(
          Map<String, dynamic> json) =>
      GetbatchcompletedlistapiresponseDatum(
        id: json["id"] ?? "",
